...
Submitted by: Jason Luker, [CITY, STATE]
...
> **DRAFT — read before filing.** Everything below is drawn from primary sources listed at the end and from
> `research/ALGORITHMIC-PRICING-COMPLIANCE-BRIEF.md` in the repository above. Bracketed items are yours to
> fill. This is your comment, in your name; change anything that does not sound like you.
