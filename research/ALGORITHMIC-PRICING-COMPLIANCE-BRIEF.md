...
**Status as of 2026-08-21.** Prepared from primary statutory sources except where marked.
...
A single national banner cannot satisfy all three. Maryland's differs from New York's by four words
that broaden it (`OR BY USING`). Connecticut's is not a variant of the other two at all: it asserts
that the price was *increased*, and it names a "price setting device" rather than an algorithm.
...
| **Watch** | *NRF v. James*, 2d Cir. No. 25-2818 — undecided. And New York's **One Fair Price Act**, passed by both houses 2026-06-04 and **not yet signed**; if signed it replaces New York's disclosure regime with a flat ban and deletes the mandated string. |
...
## 5. The California angle

*[See §5 continued below.]*
...
19. **Watch three things, in this order:** (i) whether New York's One Fair Price Act is signed —
    it deletes the mandated string and converts New York to a ban; (ii) the Second Circuit in *NRF
    v. James* — a reversal would unsettle every mandated string in the country on compelled-speech
    grounds; (iii) the FTC comment docket and whether the policy statement is finalised.
...
6. **The NY Governor's action deadline.** Under N.Y. Const. art. IV, § 7 the Governor has 10 days
...
- **California AB 2564** ("End Surveillance Pricing Act") — status after 2026-08-18 is addressed in
  §5; see that section's own verification note.
